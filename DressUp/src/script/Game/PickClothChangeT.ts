...
export default class PickClothChangeT extends Laya.Script {
    ...
    static Instance: PickClothChangeT;
    onAwake()
    {
    ...
    // newRandomData={
    //     Hair:this.HairRandomFuc(),
    //     Dress: this.DressRandomFuc(),
    //     Coat: 0,
    //     Shirt: this.ShirtRandomFuc(),
    //     Trousers: this.TrousersRandomFuc(),
    //     Socks: this.SocksRandomFuc(),
    //     Shose: this.ShoseRandomFuc(),
    //     Ornament: this.OrnamentRandomFuc(),
    // }
